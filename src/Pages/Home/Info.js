...
const Info = () => {
  return (
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 px-12">
        ...
        <InfoCard cartTitle="Visit our location" text="Brooklyn, NY 10036, United States" bgClass="bg-neutral"  img={marker}></InfoCard>
